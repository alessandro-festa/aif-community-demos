...
![data-governance-vllm architecture diagram](../images/data-governance-vllm.png)

*Every component runs on **SUSE AI Factory** (Kubernetes / Rancher). The demo UI is shown as an example only and is not part of the product. Vector source: [`../images/data-governance-vllm.svg`](../images/data-governance-vllm.svg).*
