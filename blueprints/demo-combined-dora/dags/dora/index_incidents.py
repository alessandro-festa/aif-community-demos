...
gateway"). Embeddings use a lightweight deterministic hashing embedding
(dora_common.hash_embed) — no extra model to pull, and identical on the CPU (Ollama) and GPU
(vLLM) variants so search behaves the same everywhere.
"""
...
from dora_common import (EMBED_DIM, INCIDENTS_COLLECTION, hash_embed,
